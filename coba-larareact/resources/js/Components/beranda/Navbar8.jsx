                      ...
                      <div className="auto-cols-1 grid flex-1 grid-cols-1 gap-x-8 gap-y-6 py-4 sm:py-8 md:grid-cols-3 lg:gap-y-0 lg:pr-8">
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Dapatkan informasi terbaru di sini
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Tips Jual Beli</h5>
                              <p className="hidden text-sm md:block">
                                Strategi terbaik untuk transaksi yang sukses
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Daftar Harga</h5>
                              <p className="hidden text-sm md:block">
                                Cek harga mobil terkini dengan mudah
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Baca artikel menarik tentang otomotif
                              </p>
                            </div>
                          </a>
                        </div>
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Tentang Kami</h5>
                              <p className="hidden text-sm md:block">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Ketahui lebih lanjut tentang kebijakan kami
                              </p>
                            </div>
                          </a>
                          <a
                        ...
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Baca artikel terbaru dari blog kami
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Temukan artikel yang banyak dibaca
                              </p>
                            </div>
                          </a>
                          <a
